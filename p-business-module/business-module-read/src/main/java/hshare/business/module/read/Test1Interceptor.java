...
public class Test1Interceptor implements IInterceptor {
    ...
    public static InterceptorCallback callback1;
    public static Postcard postcard1;
    ...
    public void process(final Postcard postcard, final InterceptorCallback callback) {
        if ("/read/detail".equals(postcard.getPath())) {
            final AlertDialog.Builder ab = new AlertDialog.Builder(ReadMainActivity.getThis());
...
//                    postcard.withString("extra", "我是在拦截器中附加的参数");
                    callback1 = callback;
                    postcard1 = postcard;
                    ARouter.getInstance().build("/read/login").navigation();
//                    callback.onContinue(postcard);
                }
            });
